...
export default function CategoryCard({ category, partCount }: CategoryCardProps) {
  ...
  return (
    <Link
      ...
      className={`group relative overflow-hidden rounded-2xl border border-zinc-800 bg-gradient-to-br ${cfg.gradient} p-6 transition-all duration-300 hover:border-zinc-600 ${cfg.glow}`}
    >
      {/* Background pattern */}
